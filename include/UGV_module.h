...
public:
	...
	virtual int extractData() = 0;								// Extract useful datas from scan								//added by me
	virtual int getData() = 0;									// Get data from sensor (GPS / Laser)
	virtual bool checkArrayLength() = 0;						// Check length of Data is correct								//added by me
...
protected:
	...
	//String^ Header;						// String to store Header of the datas			//added by me //change to String if fail
	bool checkLengthFlag;				// checkFlag for checkArrayLength()				//added by me
	bool checkDataFlag;					// checkFlag for checkData()					//added by me
